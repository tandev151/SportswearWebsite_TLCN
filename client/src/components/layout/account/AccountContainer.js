...
import OrderItem from "./Orders.js/OrderItem";
import {
  Select,
  FormControl,
  TextField,
...
// Xử lý chế độ kích hoạt cho địa chỉ
// 1. Nút của địa chỉ đang kích hoạt thì không thể ấn được nữa
// 2. Icon của nút được bật thì hiện màu xanh còn tất cả phải màu trong suốt
// 3. isConfig của địa chỉ được thiết lập là true, còn lại phải là false
...
const AccountContainer = () => {
  const [addresses, setAddresses] = useState([
    ...
    { id: 4, address: "56 Phổ Quang,Tân Bình, TP HCM", isConfig: false },
    { id: 5, address: "KTX khu B, Đại học quốc gia", isConfig: false },
    { id: 6, address: "Tịnh Phong, Sơn Tịnh, Quảng Ngãi", isConfig: false },
  ]);
